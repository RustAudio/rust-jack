...
pub struct JackFunctions {
    ...
    jack_set_transport_info_impl:
        unsafe extern "C" fn(*mut jack_client_t, *mut jack_transport_info_t) -> (),
    jack_get_version_impl: unsafe extern "C" fn(
        *mut ::libc::c_int,
        *mut ::libc::c_int,
        *mut ::libc::c_int,
        *mut ::libc::c_int,
    ) -> (),
    jack_get_version_string_impl: unsafe extern "C" fn() -> *const ::libc::c_char,
    ...
    jack_get_client_name_by_uuid_impl:
        unsafe extern "C" fn(*mut jack_client_t, *const ::libc::c_char) -> *mut ::libc::c_char,
    jack_internal_client_new_impl: unsafe extern "C" fn(
        *const ::libc::c_char,
        *const ::libc::c_char,
        *const ::libc::c_char,
    ) -> ::libc::c_int,
    jack_internal_client_close_impl: unsafe extern "C" fn(*const ::libc::c_char) -> (),
    ...
    jackctl_setup_signals_impl: unsafe extern "C" fn(::libc::c_uint) -> *mut jackctl_sigmask_t,
    jackctl_wait_signals_impl: unsafe extern "C" fn(*mut jackctl_sigmask_t) -> (),
    jackctl_server_create_impl: unsafe extern "C" fn(
    ...
    jackctl_server_destroy_impl: unsafe extern "C" fn(*mut jackctl_server_t) -> (),
    jackctl_server_open_impl:
        unsafe extern "C" fn(*mut jackctl_server_t, *mut jackctl_driver_t) -> u8,
    jackctl_server_start_impl: unsafe extern "C" fn(*mut jackctl_server_t) -> u8,
    jackctl_server_stop_impl: unsafe extern "C" fn(*mut jackctl_server_t) -> u8,
    jackctl_server_close_impl: unsafe extern "C" fn(*mut jackctl_server_t) -> u8,
    jackctl_server_get_drivers_list_impl:
        unsafe extern "C" fn(*mut jackctl_server_t) -> *const JSList,
    jackctl_server_get_parameters_impl:
        unsafe extern "C" fn(*mut jackctl_server_t) -> *const JSList,
    jackctl_server_get_internals_list_impl:
        unsafe extern "C" fn(*mut jackctl_server_t) -> *const JSList,
    jackctl_server_load_internal_impl:
        unsafe extern "C" fn(*mut jackctl_server_t, *mut jackctl_internal_t) -> u8,
    ...
    jackctl_driver_get_name_impl:
        unsafe extern "C" fn(*mut jackctl_driver_t) -> *const ::libc::c_char,
    jackctl_driver_get_type_impl:
        unsafe extern "C" fn(*mut jackctl_driver_t) -> jackctl_driver_type_t,
    jackctl_driver_get_parameters_impl:
        unsafe extern "C" fn(*mut jackctl_driver_t) -> *const JSList,
    jackctl_driver_params_parse_impl: unsafe extern "C" fn(
        *mut jackctl_driver_t,
        ::libc::c_int,
        *mut *mut ::libc::c_char,
    ) -> ::libc::c_int,
    jackctl_internal_get_name_impl:
        unsafe extern "C" fn(*mut jackctl_internal_t) -> *const ::libc::c_char,
    jackctl_internal_get_parameters_impl:
        unsafe extern "C" fn(*mut jackctl_internal_t) -> *const JSList,
    jackctl_parameter_get_name_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t) -> *const ::libc::c_char,
    jackctl_parameter_get_short_description_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t) -> *const ::libc::c_char,
    jackctl_parameter_get_long_description_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t) -> *const ::libc::c_char,
    jackctl_parameter_get_type_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t) -> jackctl_param_type_t,
    jackctl_parameter_get_id_impl: unsafe extern "C" fn(*mut jackctl_parameter_t) -> ::libc::c_char,
    jackctl_parameter_is_set_impl: unsafe extern "C" fn(*mut jackctl_parameter_t) -> u8,
    jackctl_parameter_reset_impl: unsafe extern "C" fn(*mut jackctl_parameter_t) -> u8,
    jackctl_parameter_get_value_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t) -> Union_jackctl_parameter_value,
    ...
    jackctl_parameter_has_range_constraint_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t) -> u8,
    jackctl_parameter_has_enum_constraint_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t) -> u8,
    jackctl_parameter_get_enum_constraints_count_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t) -> u32,
    ...
    jackctl_parameter_get_enum_constraint_description_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t, u32) -> *const ::libc::c_char,
    jackctl_parameter_get_range_constraint_impl: unsafe extern "C" fn(
    ...
    jackctl_parameter_constraint_is_fake_value_impl:
        unsafe extern "C" fn(*mut jackctl_parameter_t) -> u8,
    jack_error_impl: unsafe extern "C" fn(*const ::libc::c_char) -> (),
    jack_info_impl: unsafe extern "C" fn(*const ::libc::c_char) -> (),
    jack_log_impl: unsafe extern "C" fn(*const ::libc::c_char) -> (),
    ...
    jack_get_internal_client_name_impl:
        unsafe extern "C" fn(*mut jack_client_t, jack_intclient_t) -> *mut ::libc::c_char,
    jack_internal_client_handle_impl: unsafe extern "C" fn(
        *mut jack_client_t,
        *const ::libc::c_char,
        *mut jack_status_t,
    ) -> jack_intclient_t,
    jack_internal_client_load_impl: unsafe extern "C" fn(
        *mut jack_client_t,
        *const ::libc::c_char,
        jack_options_t,
        *mut jack_status_t,
    ...
    jack_internal_client_unload_impl:
        unsafe extern "C" fn(*mut jack_client_t, jack_intclient_t) -> jack_status_t,
...
lazy_static! {
    static ref LIB: JackFunctions = unsafe {
        let library = libloading::Library::new("libjack.so.0").unwrap();
        ...
        let jack_get_version_impl = library
            .get::<unsafe extern "C" fn(
            ...
            .unwrap();
        let jack_get_version_impl = jack_get_version_impl.into_raw();
        let jack_get_version_impl = *jack_get_version_impl.deref()
            as unsafe extern "C" fn(
                major_ptr: *mut ::libc::c_int,
                minor_ptr: *mut ::libc::c_int,
                micro_ptr: *mut ::libc::c_int,
        ...
        let jack_get_version_string_impl = library
            .get::<unsafe extern "C" fn() -> *const ::libc::c_char>(b"jack_get_version_string")
            .unwrap();
        let jack_get_version_string_impl = jack_get_version_string_impl.into_raw();
        let jack_get_version_string_impl = *jack_get_version_string_impl.deref()
        ...
        let jack_internal_client_new_impl = library
            ...
            .unwrap();
        let jack_internal_client_new_impl = jack_internal_client_new_impl.into_raw();
        let jack_internal_client_new_impl = *jack_internal_client_new_impl.deref()
            as unsafe extern "C" fn(
                client_name: *const ::libc::c_char,
                load_name: *const ::libc::c_char,
                load_init: *const ::libc::c_char,
        ...
        let jack_internal_client_close_impl = library
            ...
            .unwrap();
        let jack_internal_client_close_impl = jack_internal_client_close_impl.into_raw();
        let jack_internal_client_close_impl = *jack_internal_client_close_impl.deref()
            as unsafe extern "C" fn(client_name: *const ::libc::c_char) -> ();
        ...
        let jack_get_client_pid_impl = *jack_get_client_pid_impl.deref()
            as unsafe extern "C" fn(name: *const ::libc::c_char) -> ::libc::c_int;
        ...
        let jack_set_sample_rate_impl =
            library
                .get::<unsafe extern "C" fn(
                    client: *mut jack_client_t,
                    srate: jack_nframes_t,
                ) -> ::libc::c_int>(b"jack_set_sample_rate")
                .unwrap();
        let jack_set_sample_rate_impl = jack_set_sample_rate_impl.into_raw();
        let jack_set_sample_rate_impl = *jack_set_sample_rate_impl.deref()
            as unsafe extern "C" fn(
                client: *mut jack_client_t,
                srate: jack_nframes_t,
            ) -> ::libc::c_int;
        ...
        let jack_port_type_id_impl = *jack_port_type_id_impl.deref()
            as unsafe extern "C" fn(port: *const jack_port_t) -> jack_port_type_id_t;
        ...
        let jackctl_setup_signals_impl = library
            ...
            .unwrap();
        let jackctl_setup_signals_impl = jackctl_setup_signals_impl.into_raw();
        let jackctl_setup_signals_impl = *jackctl_setup_signals_impl.deref()
            as unsafe extern "C" fn(flags: ::libc::c_uint) -> *mut jackctl_sigmask_t;
        let jackctl_wait_signals_impl = library
            .get::<unsafe extern "C" fn(signals: *mut jackctl_sigmask_t) -> ()>(
                b"jackctl_wait_signals",
            )
            .unwrap();
        let jackctl_wait_signals_impl = jackctl_wait_signals_impl.into_raw();
        let jackctl_wait_signals_impl = *jackctl_wait_signals_impl.deref()
            as unsafe extern "C" fn(signals: *mut jackctl_sigmask_t) -> ();
        let jackctl_server_create_impl = library
            ...
            .unwrap();
        let jackctl_server_create_impl = jackctl_server_create_impl.into_raw();
        let jackctl_server_create_impl = *jackctl_server_create_impl.deref()
            as unsafe extern "C" fn(
                on_device_acquire: ::std::option::Option<
                    unsafe extern "C" fn(device_name: *const ::libc::c_char) -> u8,
                >,
        ...
        let jackctl_server_destroy_impl = library
            ...
            .unwrap();
        let jackctl_server_destroy_impl = jackctl_server_destroy_impl.into_raw();
        let jackctl_server_destroy_impl = *jackctl_server_destroy_impl.deref()
            as unsafe extern "C" fn(server: *mut jackctl_server_t) -> ();
        let jackctl_server_open_impl =
            library
                ...
                .unwrap();
        let jackctl_server_open_impl = jackctl_server_open_impl.into_raw();
        let jackctl_server_open_impl = *jackctl_server_open_impl.deref()
            as unsafe extern "C" fn(
                server: *mut jackctl_server_t,
                driver: *mut jackctl_driver_t,
            ) -> u8;
        let jackctl_server_start_impl = library
            ...
            .unwrap();
        let jackctl_server_start_impl = jackctl_server_start_impl.into_raw();
        let jackctl_server_start_impl = *jackctl_server_start_impl.deref()
            as unsafe extern "C" fn(server: *mut jackctl_server_t) -> u8;
        let jackctl_server_stop_impl = library
            .get::<unsafe extern "C" fn(server: *mut jackctl_server_t) -> u8>(
                b"jackctl_server_stop",
            )
            .unwrap();
        let jackctl_server_stop_impl = jackctl_server_stop_impl.into_raw();
        let jackctl_server_stop_impl = *jackctl_server_stop_impl.deref()
            as unsafe extern "C" fn(server: *mut jackctl_server_t) -> u8;
        let jackctl_server_close_impl = library
            ...
            .unwrap();
        let jackctl_server_close_impl = jackctl_server_close_impl.into_raw();
        let jackctl_server_close_impl = *jackctl_server_close_impl.deref()
            as unsafe extern "C" fn(server: *mut jackctl_server_t) -> u8;
        let jackctl_server_get_drivers_list_impl = library
            ...
            .unwrap();
        let jackctl_server_get_drivers_list_impl = jackctl_server_get_drivers_list_impl.into_raw();
        let jackctl_server_get_drivers_list_impl = *jackctl_server_get_drivers_list_impl.deref()
            as unsafe extern "C" fn(server: *mut jackctl_server_t) -> *const JSList;
        let jackctl_server_get_parameters_impl = library
            .get::<unsafe extern "C" fn(server: *mut jackctl_server_t) -> *const JSList>(
                b"jackctl_server_get_parameters",
            )
            .unwrap();
        let jackctl_server_get_parameters_impl = jackctl_server_get_parameters_impl.into_raw();
        let jackctl_server_get_parameters_impl = *jackctl_server_get_parameters_impl.deref()
            as unsafe extern "C" fn(server: *mut jackctl_server_t) -> *const JSList;
        ...
        let jackctl_server_get_internals_list_impl =
            jackctl_server_get_internals_list_impl.into_raw();
        let jackctl_server_get_internals_list_impl = *jackctl_server_get_internals_list_impl.deref()
            as unsafe extern "C" fn(server: *mut jackctl_server_t) -> *const JSList;
        let jackctl_server_load_internal_impl = library
            ...
            .unwrap();
        let jackctl_server_load_internal_impl = jackctl_server_load_internal_impl.into_raw();
        let jackctl_server_load_internal_impl = *jackctl_server_load_internal_impl.deref()
            as unsafe extern "C" fn(
                server: *mut jackctl_server_t,
                internal: *mut jackctl_internal_t,
            ) -> u8;
        let jackctl_server_unload_internal_impl = library
            ...
            .unwrap();
        let jackctl_server_unload_internal_impl = jackctl_server_unload_internal_impl.into_raw();
        let jackctl_server_unload_internal_impl = *jackctl_server_unload_internal_impl.deref()
            as unsafe extern "C" fn(
                server: *mut jackctl_server_t,
                internal: *mut jackctl_internal_t,
            ) -> u8;
        let jackctl_server_add_slave_impl =
            library
                ...
                .unwrap();
        let jackctl_server_add_slave_impl = jackctl_server_add_slave_impl.into_raw();
        let jackctl_server_add_slave_impl = *jackctl_server_add_slave_impl.deref()
            as unsafe extern "C" fn(
                server: *mut jackctl_server_t,
                driver: *mut jackctl_driver_t,
            ) -> u8;
        let jackctl_server_remove_slave_impl =
            library
                ...
                .unwrap();
        let jackctl_server_remove_slave_impl = jackctl_server_remove_slave_impl.into_raw();
        let jackctl_server_remove_slave_impl = *jackctl_server_remove_slave_impl.deref()
            as unsafe extern "C" fn(
                server: *mut jackctl_server_t,
                driver: *mut jackctl_driver_t,
            ) -> u8;
        let jackctl_server_switch_master_impl =
            library
                ...
                .unwrap();
        let jackctl_server_switch_master_impl = jackctl_server_switch_master_impl.into_raw();
        let jackctl_server_switch_master_impl = *jackctl_server_switch_master_impl.deref()
            as unsafe extern "C" fn(
                server: *mut jackctl_server_t,
                driver: *mut jackctl_driver_t,
            ) -> u8;
        let jackctl_driver_get_name_impl = library
            ...
            .unwrap();
        let jackctl_driver_get_name_impl = jackctl_driver_get_name_impl.into_raw();
        let jackctl_driver_get_name_impl = *jackctl_driver_get_name_impl.deref()
        ...
        let jackctl_driver_get_type_impl = library
            ...
            .unwrap();
        let jackctl_driver_get_type_impl = jackctl_driver_get_type_impl.into_raw();
        let jackctl_driver_get_type_impl = *jackctl_driver_get_type_impl.deref()
        ...
        let jackctl_driver_get_parameters_impl = library
            ...
            .unwrap();
        let jackctl_driver_get_parameters_impl = jackctl_driver_get_parameters_impl.into_raw();
        let jackctl_driver_get_parameters_impl = *jackctl_driver_get_parameters_impl.deref()
            as unsafe extern "C" fn(driver: *mut jackctl_driver_t) -> *const JSList;
        let jackctl_driver_params_parse_impl = library
            ...
            .unwrap();
        let jackctl_driver_params_parse_impl = jackctl_driver_params_parse_impl.into_raw();
        let jackctl_driver_params_parse_impl = *jackctl_driver_params_parse_impl.deref()
            as unsafe extern "C" fn(
                driver: *mut jackctl_driver_t,
                argc: ::libc::c_int,
                argv: *mut *mut ::libc::c_char,
            ) -> ::libc::c_int;
        let jackctl_internal_get_name_impl = library.get::<unsafe extern "C" fn(internal: *mut jackctl_internal_t) -> *const ::libc::c_char>(b"jackctl_internal_get_name").unwrap();
        let jackctl_internal_get_name_impl = jackctl_internal_get_name_impl.into_raw();
        let jackctl_internal_get_name_impl = *jackctl_internal_get_name_impl.deref()
        ...
        let jackctl_internal_get_parameters_impl = library
            ...
            .unwrap();
        let jackctl_internal_get_parameters_impl = jackctl_internal_get_parameters_impl.into_raw();
        let jackctl_internal_get_parameters_impl = *jackctl_internal_get_parameters_impl.deref()
            as unsafe extern "C" fn(internal: *mut jackctl_internal_t) -> *const JSList;
        let jackctl_parameter_get_name_impl = library.get::<unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> *const ::libc::c_char>(b"jackctl_parameter_get_name").unwrap();
        let jackctl_parameter_get_name_impl = jackctl_parameter_get_name_impl.into_raw();
        let jackctl_parameter_get_name_impl = *jackctl_parameter_get_name_impl.deref()
            as unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> *const ::libc::c_char;
        let jackctl_parameter_get_short_description_impl = library.get::<unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> *const ::libc::c_char>(b"jackctl_parameter_get_short_description").unwrap();
        let jackctl_parameter_get_short_description_impl =
            jackctl_parameter_get_short_description_impl.into_raw();
        let jackctl_parameter_get_short_description_impl =
            *jackctl_parameter_get_short_description_impl.deref()
                as unsafe extern "C" fn(
                    parameter: *mut jackctl_parameter_t,
                ) -> *const ::libc::c_char;
        let jackctl_parameter_get_long_description_impl = library.get::<unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> *const ::libc::c_char>(b"jackctl_parameter_get_long_description").unwrap();
        let jackctl_parameter_get_long_description_impl =
            jackctl_parameter_get_long_description_impl.into_raw();
        let jackctl_parameter_get_long_description_impl =
            *jackctl_parameter_get_long_description_impl.deref()
                as unsafe extern "C" fn(
                    parameter: *mut jackctl_parameter_t,
                ) -> *const ::libc::c_char;
        let jackctl_parameter_get_type_impl = library.get::<unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> jackctl_param_type_t>(b"jackctl_parameter_get_type").unwrap();
        let jackctl_parameter_get_type_impl = jackctl_parameter_get_type_impl.into_raw();
        let jackctl_parameter_get_type_impl = *jackctl_parameter_get_type_impl.deref()
        ...
        let jackctl_parameter_get_id_impl = library
            ...
            .unwrap();
        let jackctl_parameter_get_id_impl = jackctl_parameter_get_id_impl.into_raw();
        let jackctl_parameter_get_id_impl = *jackctl_parameter_get_id_impl.deref()
        ...
        let jackctl_parameter_is_set_impl = library
            ...
            .unwrap();
        let jackctl_parameter_is_set_impl = jackctl_parameter_is_set_impl.into_raw();
        let jackctl_parameter_is_set_impl = *jackctl_parameter_is_set_impl.deref()
            as unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> u8;
        let jackctl_parameter_reset_impl = library
            .get::<unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> u8>(
                b"jackctl_parameter_reset",
            )
            .unwrap();
        let jackctl_parameter_reset_impl = jackctl_parameter_reset_impl.into_raw();
        let jackctl_parameter_reset_impl = *jackctl_parameter_reset_impl.deref()
            as unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> u8;
        let jackctl_parameter_get_value_impl = library
            ...
            .unwrap();
        let jackctl_parameter_get_value_impl = jackctl_parameter_get_value_impl.into_raw();
        let jackctl_parameter_get_value_impl = *jackctl_parameter_get_value_impl.deref()
            as unsafe extern "C" fn(
                parameter: *mut jackctl_parameter_t,
        ...
        let jackctl_parameter_set_value_impl = library
            ...
            .unwrap();
        let jackctl_parameter_set_value_impl = jackctl_parameter_set_value_impl.into_raw();
        let jackctl_parameter_set_value_impl = *jackctl_parameter_set_value_impl.deref()
            as unsafe extern "C" fn(
                parameter: *mut jackctl_parameter_t,
                value_ptr: *const Union_jackctl_parameter_value,
            ) -> u8;
        ...
        let jackctl_parameter_get_default_value_impl =
            jackctl_parameter_get_default_value_impl.into_raw();
        ...
        let jackctl_parameter_has_range_constraint_impl =
            jackctl_parameter_has_range_constraint_impl.into_raw();
        let jackctl_parameter_has_range_constraint_impl =
            *jackctl_parameter_has_range_constraint_impl.deref()
                as unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> u8;
        ...
        let jackctl_parameter_has_enum_constraint_impl =
            jackctl_parameter_has_enum_constraint_impl.into_raw();
        ...
        let jackctl_parameter_get_enum_constraints_count_impl =
            jackctl_parameter_get_enum_constraints_count_impl.into_raw();
        let jackctl_parameter_get_enum_constraints_count_impl =
            *jackctl_parameter_get_enum_constraints_count_impl.deref()
                as unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> u32;
        ...
        let jackctl_parameter_get_enum_constraint_value_impl =
            jackctl_parameter_get_enum_constraint_value_impl.into_raw();
        let jackctl_parameter_get_enum_constraint_value_impl =
            *jackctl_parameter_get_enum_constraint_value_impl.deref()
                as unsafe extern "C" fn(
                    parameter: *mut jackctl_parameter_t,
                    index: u32,
                ) -> Union_jackctl_parameter_value;
        ...
        let jackctl_parameter_get_enum_constraint_description_impl =
            jackctl_parameter_get_enum_constraint_description_impl.into_raw();
        let jackctl_parameter_get_enum_constraint_description_impl =
            *jackctl_parameter_get_enum_constraint_description_impl.deref()
                as unsafe extern "C" fn(
                    parameter: *mut jackctl_parameter_t,
                    index: u32,
                ) -> *const ::libc::c_char;
        ...
        let jackctl_parameter_get_range_constraint_impl =
            jackctl_parameter_get_range_constraint_impl.into_raw();
        let jackctl_parameter_get_range_constraint_impl =
            *jackctl_parameter_get_range_constraint_impl.deref()
                as unsafe extern "C" fn(
                    parameter: *mut jackctl_parameter_t,
                    min_ptr: *mut Union_jackctl_parameter_value,
                    max_ptr: *mut Union_jackctl_parameter_value,
        ...
        let jackctl_parameter_constraint_is_strict_impl =
            jackctl_parameter_constraint_is_strict_impl.into_raw();
        let jackctl_parameter_constraint_is_strict_impl =
            *jackctl_parameter_constraint_is_strict_impl.deref()
                as unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> u8;
        ...
        let jackctl_parameter_constraint_is_fake_value_impl =
            jackctl_parameter_constraint_is_fake_value_impl.into_raw();
        let jackctl_parameter_constraint_is_fake_value_impl =
            *jackctl_parameter_constraint_is_fake_value_impl.deref()
                as unsafe extern "C" fn(parameter: *mut jackctl_parameter_t) -> u8;
        let jack_error_impl = library
            .get::<unsafe extern "C" fn(format: *const ::libc::c_char) -> ()>(b"jack_error")
            .unwrap();
        let jack_error_impl = jack_error_impl.into_raw();
        let jack_error_impl =
            *jack_error_impl.deref() as unsafe extern "C" fn(format: *const ::libc::c_char) -> ();
        let jack_info_impl = library
            .get::<unsafe extern "C" fn(format: *const ::libc::c_char) -> ()>(b"jack_info")
            .unwrap();
        let jack_info_impl = jack_info_impl.into_raw();
        let jack_info_impl =
            *jack_info_impl.deref() as unsafe extern "C" fn(format: *const ::libc::c_char) -> ();
        let jack_log_impl = library
            .get::<unsafe extern "C" fn(format: *const ::libc::c_char) -> ()>(b"jack_log")
            .unwrap();
        let jack_log_impl = jack_log_impl.into_raw();
        let jack_log_impl =
            *jack_log_impl.deref() as unsafe extern "C" fn(format: *const ::libc::c_char) -> ();
        ...
        let jack_get_internal_client_name_impl = library
            ...
            .unwrap();
        let jack_get_internal_client_name_impl = jack_get_internal_client_name_impl.into_raw();
        let jack_get_internal_client_name_impl = *jack_get_internal_client_name_impl.deref()
            as unsafe extern "C" fn(
                client: *mut jack_client_t,
                intclient: jack_intclient_t,
            ) -> *mut ::libc::c_char;
        let jack_internal_client_handle_impl = library
            ...
            .unwrap();
        let jack_internal_client_handle_impl = jack_internal_client_handle_impl.into_raw();
        let jack_internal_client_handle_impl = *jack_internal_client_handle_impl.deref()
            as unsafe extern "C" fn(
                client: *mut jack_client_t,
                client_name: *const ::libc::c_char,
                status: *mut jack_status_t,
        ...
        let jack_internal_client_load_impl = library
            ...
            .unwrap();
        let jack_internal_client_load_impl = jack_internal_client_load_impl.into_raw();
        let jack_internal_client_load_impl = *jack_internal_client_load_impl.deref()
            as unsafe extern "C" fn(
                client: *mut jack_client_t,
                client_name: *const ::libc::c_char,
                options: jack_options_t,
        ...
        let jack_internal_client_unload_impl = library
            ...
            .unwrap();
        let jack_internal_client_unload_impl = jack_internal_client_unload_impl.into_raw();
        let jack_internal_client_unload_impl = *jack_internal_client_unload_impl.deref()
            as unsafe extern "C" fn(
                client: *mut jack_client_t,
                intclient: jack_intclient_t,
            ) -> jack_status_t;
        ...
        let jack_midi_reset_buffer_impl = library
            .get::<unsafe extern "C" fn(port_buffer: *mut ::libc::c_void) -> ()>(
                b"jack_midi_reset_buffer",
            )
            .unwrap();
        let jack_midi_reset_buffer_impl = jack_midi_reset_buffer_impl.into_raw();
        let jack_midi_reset_buffer_impl = *jack_midi_reset_buffer_impl.deref()
            as unsafe extern "C" fn(port_buffer: *mut ::libc::c_void) -> ();
        ...
        let jack_ringbuffer_reset_impl = *jack_ringbuffer_reset_impl.deref()
            as unsafe extern "C" fn(rb: *mut jack_ringbuffer_t) -> ();
        let jack_ringbuffer_reset_size_impl = library
            .get::<unsafe extern "C" fn(rb: *mut jack_ringbuffer_t, sz: ::libc::size_t) -> ()>(
                b"jack_ringbuffer_reset_size",
            )
            .unwrap();
        let jack_ringbuffer_reset_size_impl = jack_ringbuffer_reset_size_impl.into_raw();
        let jack_ringbuffer_reset_size_impl = *jack_ringbuffer_reset_size_impl.deref()
            as unsafe extern "C" fn(rb: *mut jack_ringbuffer_t, sz: ::libc::size_t) -> ();
        ...
        JackFunctions {
            ...
            jack_get_transport_info_impl,
            jack_set_transport_info_impl,
            jack_get_version_impl,
            jack_get_version_string_impl,
...
pub unsafe fn jack_get_cycle_times(
    ...
    let f = LIB
        .jack_get_cycle_times_impl
        .expect("function jack_get_cycle_times not found");
    f(
        client,
        current_frames,
        current_usecs,
...
pub unsafe fn jack_set_sync_timeout(
    ...
    let f = LIB.jack_set_sync_timeout_impl;
    f(client, timeout)
}
pub unsafe fn jack_set_timebase_callback(
    ...
    let f = LIB.jack_set_timebase_callback_impl;
...
pub unsafe fn jack_transport_locate(
    ...
    let f = LIB.jack_transport_locate_impl;
    f(client, frame)
}
...
pub unsafe fn jack_get_transport_info(
    ...
    let f = LIB.jack_get_transport_info_impl;
    f(client, tinfo)
}
pub unsafe fn jack_set_transport_info(
    ...
    let f = LIB.jack_set_transport_info_impl;
    f(client, tinfo)
}
pub unsafe fn jack_get_version(
    major_ptr: *mut ::libc::c_int,
    minor_ptr: *mut ::libc::c_int,
    micro_ptr: *mut ::libc::c_int,
    proto_ptr: *mut ::libc::c_int,
) -> () {
    let f = LIB.jack_get_version_impl;
    f(major_ptr, minor_ptr, micro_ptr, proto_ptr)
}
pub unsafe fn jack_get_version_string() -> *const ::libc::c_char {
    let f = LIB.jack_get_version_string_impl;
    f()
}
...
pub unsafe fn jack_get_uuid_for_client_name(
    ...
    let f = LIB.jack_get_uuid_for_client_name_impl;
...
pub unsafe fn jack_set_process_thread(
    ...
    let f = LIB.jack_set_process_thread_impl;
...
pub unsafe fn jack_set_thread_init_callback(
    ...
    let f = LIB.jack_set_thread_init_callback_impl;
...
pub unsafe fn jack_on_shutdown(
    ...
    let f = LIB.jack_on_shutdown_impl;
...
pub unsafe fn jack_on_info_shutdown(
    ...
    let f = LIB.jack_on_info_shutdown_impl;
    f(client, callback, arg)
}
pub unsafe fn jack_set_process_callback(
    ...
    let f = LIB.jack_set_process_callback_impl;
...
pub unsafe fn jack_set_freewheel_callback(
    ...
    let f = LIB.jack_set_freewheel_callback_impl;
...
pub unsafe fn jack_set_sample_rate_callback(
    ...
    let f = LIB.jack_set_sample_rate_callback_impl;
...
pub unsafe fn jack_set_client_registration_callback(
    ...
    let f = LIB.jack_set_client_registration_callback_impl;
...
pub unsafe fn jack_set_port_registration_callback(
    ...
    let f = LIB.jack_set_port_registration_callback_impl;
    f(client, registration_callback, arg)
}
pub unsafe fn jack_set_port_connect_callback(
    ...
    let f = LIB.jack_set_port_connect_callback_impl;
...
pub unsafe fn jack_set_port_rename_callback(
    ...
    let f = LIB.jack_set_port_rename_callback_impl;
...
pub unsafe fn jack_set_graph_order_callback(
    ...
    let f = LIB.jack_set_graph_order_callback_impl;
...
pub unsafe fn jack_set_xrun_callback(
    ...
    let f = LIB.jack_set_xrun_callback_impl;
...
pub unsafe fn jack_set_latency_callback(
    ...
    let f = LIB.jack_set_latency_callback_impl;
...
pub unsafe fn jack_set_freewheel(
    ...
    let f = LIB.jack_set_freewheel_impl;
    f(client, onoff)
}
...
pub unsafe fn jack_port_register(
    ...
    let f = LIB.jack_port_register_impl;
...
pub unsafe fn jack_port_unregister(
    ...
    let f = LIB.jack_port_unregister_impl;
    f(client, port)
}
...
pub unsafe fn jack_port_connected(port: *const jack_port_t) -> ::libc::c_int {
    let f = LIB.jack_port_connected_impl;
    f(port)
}
...
pub unsafe fn jack_port_set_name(
    ...
    let f = LIB.jack_port_set_name_impl;
    f(port, port_name)
}
pub unsafe fn jack_port_set_alias(
    ...
    let f = LIB.jack_port_set_alias_impl;
    f(port, alias)
}
pub unsafe fn jack_port_unset_alias(
    ...
    let f = LIB.jack_port_unset_alias_impl;
    f(port, alias)
}
pub unsafe fn jack_port_get_aliases(
    ...
    let f = LIB.jack_port_get_aliases_impl;
    f(port, aliases)
}
pub unsafe fn jack_port_request_monitor(
    ...
    let f = LIB.jack_port_request_monitor_impl;
    f(port, onoff)
}
pub unsafe fn jack_port_request_monitor_by_name(
    ...
    let f = LIB.jack_port_request_monitor_by_name_impl;
...
pub unsafe fn jack_port_ensure_monitor(
    ...
    let f = LIB.jack_port_ensure_monitor_impl;
    f(port, onoff)
}
pub unsafe fn jack_port_monitoring_input(port: *mut jack_port_t) -> ::libc::c_int {
    let f = LIB.jack_port_monitoring_input_impl;
    f(port)
}
...
pub unsafe fn jack_disconnect(
    ...
    let f = LIB.jack_disconnect_impl;
    f(client, source_port, destination_port)
}
pub unsafe fn jack_port_disconnect(
    ...
    let f = LIB.jack_port_disconnect_impl;
    f(client, port)
}
pub unsafe fn jack_port_name_size() -> ::libc::c_int {
    let f = LIB.jack_port_name_size_impl;
    f()
}
pub unsafe fn jack_port_type_size() -> ::libc::c_int {
    let f = LIB.jack_port_type_size_impl;
    f()
}
pub unsafe fn jack_port_type_get_buffer_size(
    ...
    let f = LIB.jack_port_type_get_buffer_size_impl;
    f(client, port_type)
}
pub unsafe fn jack_port_set_latency(port: *mut jack_port_t, arg1: jack_nframes_t) -> () {
    let f = LIB.jack_port_set_latency_impl;
    f(port, arg1)
}
pub unsafe fn jack_port_get_latency_range(
    ...
    let f = LIB.jack_port_get_latency_range_impl;
    f(port, mode, range)
}
...
pub unsafe fn jack_port_get_total_latency(
    ...
    let f = LIB.jack_port_get_total_latency_impl;
    f(client, port)
}
pub unsafe fn jack_recompute_total_latency(
    ...
    let f = LIB.jack_recompute_total_latency_impl;
    f(arg1, port)
}
...
pub unsafe fn jack_port_by_name(
    ...
    let f = LIB.jack_port_by_name_impl;
    f(client, port_name)
}
...
pub unsafe fn jack_frames_to_time(
    ...
    let f = LIB.jack_frames_to_time_impl;
    f(client, arg1)
}
...
pub unsafe fn jack_set_session_callback(
    ...
    let f = LIB.jack_set_session_callback_impl;
...
pub unsafe fn jack_reserve_client_name(
    ...
    let f = LIB.jack_reserve_client_name_impl;
    f(client, name, uuid)
}
...
pub unsafe fn jack_error(format: *const ::libc::c_char) -> () {
    let f = LIB.jack_error_impl;
    f(format)
}
pub unsafe fn jack_info(format: *const ::libc::c_char) -> () {
    let f = LIB.jack_info_impl;
    f(format)
}
pub unsafe fn jack_log(format: *const ::libc::c_char) -> () {
    let f = LIB.jack_log_impl;
    f(format)
}
...
pub unsafe fn jack_get_property(
    ...
    let f = LIB.jack_get_property_impl;
...
pub unsafe fn jack_free_description(
    ...
    let f = LIB.jack_free_description_impl;
...
pub unsafe fn jack_remove_property(
    ...
    let f = LIB.jack_remove_property_impl;
...
pub unsafe fn jack_remove_properties(
    ...
    let f = LIB.jack_remove_properties_impl;
    f(client, subject)
}
pub unsafe fn jack_remove_all_properties(client: *mut jack_client_t) -> ::libc::c_int {
    let f = LIB.jack_remove_all_properties_impl;
    f(client)
}
...
pub unsafe fn jack_midi_event_get(
    ...
    let f = LIB.jack_midi_event_get_impl;
...
pub unsafe fn jack_midi_max_event_size(port_buffer: *mut ::libc::c_void) -> ::libc::size_t {
    let f = LIB.jack_midi_max_event_size_impl;
    f(port_buffer)
}
pub unsafe fn jack_midi_event_reserve(
    ...
    let f = LIB.jack_midi_event_reserve_impl;
...
pub unsafe fn jack_ringbuffer_get_read_vector(
    ...
    let f = LIB.jack_ringbuffer_get_read_vector_impl;
    f(rb, vec)
}
pub unsafe fn jack_ringbuffer_get_write_vector(
    ...
    let f = LIB.jack_ringbuffer_get_write_vector_impl;
    f(rb, vec)
}
pub unsafe fn jack_ringbuffer_read(
    ...
    let f = LIB.jack_ringbuffer_read_impl;
    f(rb, dest, cnt)
}
